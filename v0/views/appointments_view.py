...
class AppointmentsView(QWidget):
    ...
    def __init__(self, db_manager, translation_manager, appointments_controller, clients_controller, services_controller, is_admin):
        super().__init__()
    ...
    def load_appointments(self):
        appointments = self.appointments_controller.get_all_appointments()
    ...
    def search(self, text):
        ...
        appointments = self.appointments_controller.search_appointments(text)
    ...
    def delete_appointment(self):
        ...
        if reply == QMessageBox.StandardButton.Yes:
            try:
                self.appointments_controller.delete_appointment(appointment_id)
                self.load_appointments()
...
class AppointmentDialog(QDialog):
    """Dialog for adding, editing, or viewing an appointment."""
    
    def __init__(self, db_manager, translation_manager, appointments_controller, clients_controller, services_controller, appointment_id=None, view_only=False):
        super().__init__()
        self.db_manager = db_manager
        self.translation_manager = translation_manager
        self.appointments_controller = appointments_controller
    ...
    def save_appointment(self):
        ...
        try:
            if self.appointment_id:
                ...
                self.appointments_controller.update_appointment(self.appointment_id, appointment_data)
            else:
                # Add new appointment
                self.appointments_controller.add_appointment(appointment_data)
