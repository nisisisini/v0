...
class ServicesView(QWidget):
    ...
    def __init__(self, db_manager, translation_manager, services_controller, is_admin):
        super().__init__()
    ...
    def search(self, text):
        ...
        services = self.services_controller.search_services(text)
    ...
    def add_service(self):
        ...
        dialog = ServiceDialog(self.db_manager, self.translation_manager, self.services_controller)
    ...
    def edit_service(self):
        ...
        dialog = ServiceDialog(self.db_manager, self.translation_manager, self.services_controller, service_id)
        if dialog.exec() == QDialog.DialogCode.Accepted:
            self.load_services()
    ...
    def delete_service(self):
        ...
        if reply == QMessageBox.StandardButton.Yes:
            try:
                self.services_controller.delete_service(service_id)
                self.load_services()
    ...
    def view_service(self):
        ...
        dialog = ServiceDialog(self.db_manager, self.translation_manager, self.services_controller, service_id, view_only=True)
        dialog.exec()


class ServiceDialog(QDialog):
    """Dialog for adding, editing, or viewing a service."""
    
    def __init__(self, db_manager, translation_manager, services_controller, service_id=None, view_only=False):
        super().__init__()
        self.db_manager = db_manager
        self.translation_manager = translation_manager
        self.services_controller = services_controller
    ...
    def save_service(self):
        ...
        try:
            if self.service_id:
                ...
                self.services_controller.update_service(self.service_id, name, price)
            else:
                # Add new service
                self.services_controller.add_service(name, price)
